...
!BOC
      ...
      call self%register_diagnostic_variable(self%id_Carb,  'Carb',  'mmol/m3','carbonate concentration')
      ...
      call self%register_dependency(self%id_pco2_in,'pCO2')
      call self%register_dependency(self%id_Carb_in,'Carb')
