...
!# R6f --- umol/m^3 --- Medium size POF --- M 
   ...
   ! Particulate organic matter (medium-size)
   ...
   call self%register_diagnostic_variable(self%id_netP1,'GPP','mmol/m**3',  'gross primary production', time_treatment=time_treatment_step_integrated)
...
#ifdef DOCDYN
      fP1R1c=  (1._rk-pe_R6P1)*sdoP1*P1cP(I)
