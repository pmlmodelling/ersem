module ersem_shared
   ...
   type (type_horizontal_standard_variable),parameter :: particulate_diffusivity_representing_bioturbation = type_horizontal_standard_variable(name='particulate_diffusivity_representing_bioturbation',units='m^2/d')
