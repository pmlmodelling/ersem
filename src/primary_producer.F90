...
!BOC
      ...
      call self%register_diagnostic_variable(self%id_fPIR1n,'fPIR1n','mmol N/m^3/d','phytoplankton loss to labile DON')
      call self%register_diagnostic_variable(self%id_fPIR1p,'fPIR1p','mmol P/m^3/d','phytoplankton loss to labile DOP')
