...
contains
   ...
   subroutine initialize(self,configunit)
      ...
      call self%register_diagnostic_variable(self%id_pco2,  'pCO2',  '1e-6',    'partial pressure of CO2',domain=domain_bottom)
      call self%register_diagnostic_variable(self%id_CarbA, 'CarbA', 'mmol/m^3','carbonic acid concentration',domain=domain_bottom)
      call self%register_diagnostic_variable(self%id_BiCarb,'BiCarb','mmol/m^3','bicarbonate concentration',domain=domain_bottom)
      call self%register_diagnostic_variable(self%id_Carb,  'Carb',  'mmol/m^3','carbonate concentration',domain=domain_bottom)
      call self%register_diagnostic_variable(self%id_Om_cal,'Om_cal','-','calcite saturation',domain=domain_bottom)
      call self%register_diagnostic_variable(self%id_Om_arg,'Om_arg','-','aragonite saturation',domain=domain_bottom)
